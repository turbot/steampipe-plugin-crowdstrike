...
func tableCrowdStrikeIntelActor(_ context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "created_date", Description: "The creation date.", Type: proto.ColumnType_TIMESTAMP, Transform: transform.FromField("CreatedDate").Transform(epochTimestampTransformer)},
			...
			{Name: "first_activity_date", Description: "Date when first activity was detected.", Type: proto.ColumnType_TIMESTAMP, Transform: transform.FromField("FirstActivityDate").Transform(epochTimestampTransformer)},
			...
			{Name: "last_activity_date", Description: "Date of last activity.", Type: proto.ColumnType_TIMESTAMP, Transform: transform.FromField("LastActivityDate").Transform(epochTimestampTransformer)},
			{Name: "last_modified_date", Description: "Date when this actor was last modified.", Type: proto.ColumnType_TIMESTAMP, Transform: transform.FromField("LastModifiedDate").Transform(epochTimestampTransformer)},
